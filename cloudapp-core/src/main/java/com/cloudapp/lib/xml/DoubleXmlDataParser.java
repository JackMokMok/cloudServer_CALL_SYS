...
public class DoubleXmlDataParser implements XmlDataParser {
	@Override
	...
	public void parseXml(Element parent, Field field, Object object)
		...
		if (a != null) {
			Method m = object.getClass().getMethod(
					ReflectUtil.setterMethod(field.getName()), Double.class);
			m.invoke(object, Double.parseDouble(a.getValue()));
		}
	}
}
